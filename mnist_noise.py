...
if data_name == 'mnist':
    ...
    trainset.original_labels = trainset.dataset.targets[noise_indices]
    trainset.dataset.targets[noise_indices] = torch.from_numpy(np.random.choice(np.arange(num_cls), size=noise_bud, replace=True)).type(torch.long)
...
print(facloc_reg_noise_selected)
...
plt.title('Subset Training Loss vs Epochs ' + data_name + '_' + str(fraction) + '_' + str(noise_ratio) + '_' + 'val=VAL')
...
plt.title('Full Training Loss vs Epochs ' + data_name + '_' + str(fraction) + '_' + str(noise_ratio) + '_' + 'val=VAL')
...
plt.title('Validation Loss vs Epochs ' + data_name + '_' + str(fraction) + '_' + str(noise_ratio) + '_' + 'val=VAL')
plt_file = path_logfile + '_' + str(fraction) + 'valloss_v=VAL.png'
plt.savefig(plt_file)
plt.clf()
with open(path_logfile, 'w') as logfile:
    ...
    print('*| random regularized Taylor after training               |', rand_reg_noise_selected,' |', file=logfile)
    print('*| facloc regularizec Taylor after training               |', facloc_reg_noise_selected, '  | ', file=logfile)
    print("\n", file=logfile)
...
with open(all_logs_dir + '/mod_one_step_subset_selected_' + str(noise_ratio) + '.txt', 'w') as log_file:
    print(mod_subset_idxs, file=log_file)

subset_idxs = list(one_subset_idxs)
with open(all_logs_dir + '/one_step_subset_selected_' + str(noise_ratio) + '.txt', 'w') as log_file:
    print(subset_idxs, file=log_file)

rand_subset_idxs = list(rand_reg_subset_idxs)
with open(all_logs_dir + '/rand_reg_one_step_subset_selected_' + str(noise_ratio) + '.txt', 'w') as log_file:
    print(rand_subset_idxs, file=log_file)

facloc_reg_subset_idxs = list(facloc_reg_subset_idxs)
with open(all_logs_dir + '/facloc_reg_one_step_subset_selected_' + str(noise_ratio) + '.txt', 'w') as log_file:
    print(facloc_reg_subset_idxs, file=log_file)

random_subset_idx = list(random_subset_idx)
with open(all_logs_dir + '/random_subset_selected_' + str(noise_ratio) + '.txt', 'w') as log_file:
    print(random_subset_idx, file=log_file)

facloc_idxs = list(facloc_idxs)
with open(all_logs_dir + '/facloc_subset_selected_' +str(noise_ratio) + '.txt', 'w') as log_file:
